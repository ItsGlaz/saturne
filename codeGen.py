...
def mWinCode(old_data, data, project_path):
    ...
    project_path:
        chemin de dossier où est enregistrer le code
...
def createWidCode(data : dict):
    ...
    ------
    init_seq:
        ligne de création du widget
        nom de variable du widget = CTK...(paramètres)
        
    layout_seq:
        ligne d'affichage du widget
...
def delWidCode(widget, wid_id, project_path):
    """delWidCode
    fonction pour supprimer le code d'un widget
    
    Parameters
    ----------
    widget:
        nom du widget à supprimetr
    wid_id:
        id du widget à supprimer
    project_path:
        chemin du projet
    """
    widinfo = fileop.loadInfo(data = "widsets")
